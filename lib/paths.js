...
export const agentJobPlanningMd = path.join(PROJECT_ROOT, 'config', 'AGENT_JOB_PLANNING.md');
export const codePlanningMd = path.join(PROJECT_ROOT, 'config', 'CODE_PLANNING.md');
export const agentJobSummaryMd = path.join(PROJECT_ROOT, 'config', 'AGENT_JOB_SUMMARY.md');
